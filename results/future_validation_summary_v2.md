...
- Historical v2 LLM-scored edges before cutoff: `55`
...
- Compared with the old semantic layer, Full model Spearman changed from `-0.0839` to `0.1628` and NDCG@10 changed from `0.2299` to `0.5158`.
