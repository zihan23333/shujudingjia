...
- citing paper title: Business Data Sharing through Data Marketplaces: A Systematic Literature Review
- cited paper title: Pricing for Revenue Maximization in IoT Data Markets: An Information Design Perspective
- target reference marker: 129
- target reference entry: Mao, W.; Zheng, Z.; Wu, F. Pricing for Revenue Maximization in IoT Data Markets: An Information Design Perspective. In Proceedings of the IEEE INFOCOM 2019—IEEE Conference on Computer Communications, Paris, France, 29 April–2 May 2019 ; pp. 1837–1845.
- alignment status: grouped
...
Res. 2021 ,16 3329 The topics of this category include data trading models that consider contract the- ory [ 128], information design perspective [ 129], and equilibrium pricing mechanism based on Stackelberg game approach [ 130]. Moreover, pricing mechanisms speciﬁcally for per- sonal data are also discussed.
